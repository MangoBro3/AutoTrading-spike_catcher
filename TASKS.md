...
|---:|:---:|:---:|:---|:---:|:---|:---|:---|:---:|
| T-001 | DONE | PM | Hybrid v1.2 core + backtest runner integration (Phase 1) | None | A:engine/**,alloc/** B:guards/**,backtest/**,run_backtest.py | contracts/T-001.contract.v1.json | `/mnt/f/SafeBot/openclaw-news-workspace/python/backtest/out_relsplit_B1/runner_summary.json` | 0/3 |
...
- TL 최종 게이트 기준 경로: `/mnt/f/SafeBot/openclaw-news-workspace/python/backtest/out_relsplit_B1/runner_summary.json`
